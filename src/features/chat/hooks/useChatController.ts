...
export function useChatController(): ChatController {
  ...
  return {
    ...
    sidebar: {
      ...
      showCreateGroupModal: directory.showCreateGroupModal,
      groupCandidates: directory.groupCandidates,
      visibleGroupCandidates: directory.visibleGroupCandidates,
      groupName: directory.groupName,
      setGroupName: directory.setGroupName,
      groupMemberIds: directory.groupMemberIds,
      groupSearch: directory.groupSearch,
      setGroupSearch: directory.setGroupSearch,
      groupVisibleCount: directory.groupVisibleCount,
      usersById,
      ...
      openCreateGroupModal: directory.openCreateGroupModal,
      closeCreateGroupModal: directory.closeCreateGroupModal,
